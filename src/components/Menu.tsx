        ...
        {onToggleSessionScrollMode && (
          <div className="menu-center__row menu-center__row--secondary">
            <div className="session-scroll-toggle">
              <span className={`session-scroll-toggle__label ${isLightTheme ? 'session-scroll-toggle__label--light' : 'session-scroll-toggle__label--dark'}`}>
                Сессии:
              </span>
              <div className="session-scroll-toggle__controls">
                <button
                  onClick={() => onToggleSessionScrollMode('all')}
                  className={`time-toggle-option ${sessionScrollMode === 'all' ? 'time-toggle-option--active' : ''} ${isLightTheme ? 'time-toggle-option--light' : 'time-toggle-option--dark'}`}
                >
                  Все
                </button>
                <button
